...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.tangram = new MyTangram(this, this.createTexture('images/tangram.png'));
        this.cube = new MyUnitCubeQuad(this, this.createTexture('images/mineTop.png'), this.createTexture('images/mineSide.png'), this.createTexture('images/mineSide.png'), this.createTexture('images/mineSide.png'), this.createTexture('images/mineSide.png'), this.createTexture('images/mineBottom.png'));
