...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/tp5-11.vert", "shaders/tp5-11.frag"),
			new CGFshader(this.gl, "shaders/tp5-12.vert", "shaders/tp5-12.frag"),
			new CGFshader(this.gl, "shaders/tp5-11.vert", "shaders/tp5-13.frag"),
			new CGFshader(this.gl, "shaders/water.vert", "shaders/water.frag") //12
		];
